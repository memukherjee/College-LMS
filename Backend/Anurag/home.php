        ...
        <div class="row row-cols-4">
          <h1 class="ml11 col-12">
            <span class="text-wrapper">
              ...
              <span class="letters">Hi <?php echo $_SESSION['name']; ?></span>
            </span>
          </h1>
          ...
          <div class="card col-12 col-md mt-2">
            ...
            <div class="btn-group" role="group" aria-label="Department">
              <button type="button" class="btn field">Department</button>
              <button type="button" class="btn"><?php echo $_SESSION['dept']; ?></button>
            </div>
          </div>
              ...
              <li class="list-group-item">
                <p>
                  <a class="btn" data-bs-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fas fa-angle-double-right blink"></i> 1st Work todo
                  </a>
                </p>
              ...
              <li class="list-group-item">
                <p>
                  <a class="btn" data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fas fa-angle-double-right blink"></i> 2nd Work todo
                  </a>
                </p>
              ...
              <li class="list-group-item">
                <p>
                  <a class="btn" data-bs-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fas fa-angle-double-right blink"></i> 3rd Work todo
                  </a>
                </p>
